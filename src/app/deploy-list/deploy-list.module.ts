...
import { DeploySummaryComponent } from './deploy-summary/deploy-summary.component';

@NgModule({
  declarations: [DeployListComponent, DeployStateChangeComponent, DeploySummaryComponent],
  imports: [
    CommonModule,
